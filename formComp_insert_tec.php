        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    $query1= "INSERT INTO BASE_GRADOCOMPAC VALUES ('$folio_gc','$cliente','$ubicacion',$no_cala,'$de','$nivel','$compactacion_req','$fecha','$para_emplearse',NULL)";
                    ...
                    <a type="button" class="btn btn-outline-primary btn-block" href="formComp_existente_tec.php">NUEVA CALA de proyecto existente</a>
                </div>
            </div>
        </div>
    </section>

            ...
            <div class="container">
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a href="formRes_tec.php" class="nav-link link-scroll">Nueva Resistencia de Concreto</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a type="button" class="btn btn-outline-primary btn-block" href="formRes_tec.php">Nuevo formulario RESISTENCIA DE CONCRETO</a>
                    <a type="button" class="btn btn-outline-primary btn-block" href="formRes_existente_tec.php">NUEVA MUESTRA RESISTENCIA DE CONCRETO</a>
                </div>
            </div>
        </div>
    </section>

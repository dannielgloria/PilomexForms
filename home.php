...
<body>
    ...
    <header class="header">
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a href="#intro" class="navbar-brand link-scroll"><img src="img/logo.png" alt="" class="img-fluid"></a>
                <button type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler navbar-toggler-right"><i class="fa fa-bars"></i></button>
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a href="index.html#about" class="nav-link link-scroll">Nosotros </a></li>
                        <li class="nav-item"><a href="index.html#services" class="nav-link link-scroll">Servicios</a></li>
                        <li class="nav-item"><a href="index.html#portfolio" class="nav-link link-scroll">Portafolio</a></li>
                        <li class="nav-item"><a href="index.html#text" class="nav-link link-scroll">Más</a></li>
                        <li class="nav-item"><a href="index.html#contact" class="nav-link link-scroll">Contacto</a></li>
                        <li class="nav-item " style="background-color: black;"><a href="login.html" class="nav-link link-scroll" style="color: #fff;">Cerrar sesión</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <section id="services" style="background-color: #eee">
        <div class="container">
            <div class="row services">
                <div class="col-lg-12">
                    <h2 class="heading">Formularios</h2>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                <div class="icon"><img src="https://img.icons8.com/ios-filled/48/000000/ground.png" /></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <h5>Dar de alta</h5>
                            <p>Ingrese la información sobre el nuevo empleado<br><br></p>
                            <a type="button" class="btn btn-outline-primary btn-block" href="tecnico.html">Dar de alta empleado</a>
                        </div>
                        <div class="col-md-4">

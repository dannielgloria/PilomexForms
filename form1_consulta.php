                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="text-center">
                            <input type="button" onclick="submitForm('form1_editarcolado_admin.php')" value="Buscar Colado" class="btn btn-outline-primary btn-block">
                        </div>
                        <br>
                        <div class="text-center">
                            <input type="button" onclick="submitForm('form1_editarproyecto_admin.php')" value="Buscar Proyecto" class="btn btn-outline-primary btn-block">
                        </div>
                    </div>
                </div>
            </div>

...
<body>
            ...
            <div class="container">
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item " style="background-color: black;"><a href="login.html" class="nav-link link-scroll" style="color: #fff;">Iniciar sesión</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    $query= "SELECT contrasenia FROM EMPLEADOS WHERE correo = '$correo'";
    ...
    $renglon=mysqli_fetch_array($resultado,MYSQLI_NUM);
        ...
        $body = "<!DOCTYPE html><html lang='es'><head><meta charset='UTF-8'><title>Recuperación de contraseña PILOMEX</title></head><body>";

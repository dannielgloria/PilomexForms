...
<body>
            ...
            <div class="container">
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="formRes.php" class="nav-link link-scroll">Resistencia de Concreto</a></li>
                        <li class="nav-item"><a href="formComp.php" class="nav-link link-scroll">Grado de Compactación</a></li>
                        <li class="nav-item" style="background-color: black"><a href="#contact" class="btn btn-outline-white nav-link" style="color: #fff">Cerrar sesión</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    function password($longitud) {
        ...
        $body = "<!DOCTYPE html><html lang='es'><head><meta charset='UTF-8'><title>Contraseña PILOMEX</title></head><body>";
        $body .= "<table style='width: 100%;'>";
        $body .= "<thead style='text-align: center;'><tr><td style='border:none;' colspan='2'>";
        $body .= "<a href='{$link}'><img src='{$logo}' style='{$style}' alt='PILOMEX'></a><br><br>";
        $body .= "</td></tr></thead><tbody><tr>";
        $body .= "<td style='border:none;'><strong>Nombre:</strong> {$name} {$lastname}</td>";
        ...
        $cargo = $_POST ['cargo'];
        $query= "INSERT INTO EMPLEADOS VALUES ('$correo','$contrasenia','$nombre','$apellidos','$cargo')";
    ...
    ?>    
    <!-- Tecnico (formulario para alta de tecnio) -->
    <section id="tecnico" style="background-color: #fff;" class="text-page pb-4">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="heading">Alta de empleado</h1>
                    <form id="contact-form" action="home.php" method="post" class="contact-form">
                        <div class="controls" align="center">
                            <p>Se ha enviado un e-mail al correo </p>
                            <p>que se ingreso en el formulario y </p> 
                            <p>dentro de este encontrara su contraseña</p>

            ...
            <div class="container">
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a href="formRev_tec.php" class="nav-link link-scroll">Nuevo Revenimiento</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form id="contact-form" action="formRev_existente_insert_tec.php" method="post" class="contact-form">
                        <div class="controls">

            ...
            <div class="container">
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a href="formRes_existente_tec.php" class="nav-link link-scroll">R. Concreto Existente</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form id="contact-form" action="formRes_insert_tec.php" method="post" class="contact-form">
                        <div class="controls">
                            <div class="row">
                                <div class="col-md-6">

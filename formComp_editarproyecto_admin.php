            ...
            <div class="container">
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="formComp_consulta.php" class="nav-link link-scroll">Consultar Grado de Compactación</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="text-center">
                            <input type="button" onclick="submitForm('formComp_editarcala_admin.php')" value="Editar" class="btn btn-outline-primary btn-block">
                        </div>
                        <br>
                        <div class="text-center">
                            <input type="button" onclick="submitForm('formComp_admin_descargable.php')" value="Descargar" class="btn btn-outline-primary btn-block">
                        </div>
                    </div>
                </div>
            </div>

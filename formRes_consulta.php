        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    ...
                    <li class="nav-item"><a href="formRes_existente.php" class="nav-link link-scroll">Resistencia de Concreto Existente</a></li>
                        <li class="nav-item"><a href="formRes.php" class="nav-link link-scroll">Resistencia de Concreto Nuevo</a></li>
    ...
    <section id="revendimiento" style="background-color: #fff;" class="text-page pb-4">
        <form id="contact-form" method="post" class="contact-form">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="heading">BÚSQUEDA RESISTENCIA</h1>
                        <br>
